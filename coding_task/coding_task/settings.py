...
SECRET_KEY = 'django-insecure-wjn40u(rd=$q5i92otr#g^a#cp%tsvlj)&t98fhd^f6=!c4!&q'
...
# STATICFILES_DIRS = [
#     os.path.join(BASE_DIR, 'static'),  # Example directory for storing app-specific static files
# ]
